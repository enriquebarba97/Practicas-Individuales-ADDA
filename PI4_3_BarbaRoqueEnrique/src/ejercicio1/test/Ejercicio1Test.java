...
public class Ejercicio1Test {
	...
	public static void main(String[] args) {
		...
		alg.ejecuta();
		System.out.println("Solución con PD: " + alg.getSolucion());
		...
		System.out.println("Solución con BT: "+algBT.getSolucion());
		...
		System.out.println("Solución con Grafos Virtuales: "+Ejercicio1Vertex.getSolucion(camino));
